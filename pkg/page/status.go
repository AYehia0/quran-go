...
// Statusbar represents the properties of the statusbar.
...
func NewStatus(firstColumnColors, secondColumnColors, thirdColumnColors, fourthColumnColors ColorConfig) Statusbar {
	return Statusbar{
...
func (b *Statusbar) SetContent(firstColumn, secondColumn, thirdColumn, fourthColumn string) {
...
func (b *Statusbar) SetColors(firstColumnColors, secondColumnColors, thirdColumnColors, fourthColumnColors ColorConfig) {
